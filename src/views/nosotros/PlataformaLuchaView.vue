<template>
    <v-card class="mx-auto mt-15" elevation="11" subtitle="Sindicato de trabajadores y empleados del SENA" width="500" >
      <template v-slot:title>
        ...
        />
        <span class="font-weight-black">Plataforma de lucha</span>
      </template>
